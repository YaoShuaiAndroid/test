...
import com.liji.imagezoom.util.StatusBarCompat;
...
public class ImagePagerActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //状态栏兼容处理
        StatusBarCompat.compat(ImagePagerActivity.this,4);
        ...
        topLeftRel= (RelativeLayout) findViewById(R.id.top_left_rel);
        topLeftRel.setOnClickListener(new View.OnClickListener() {
            @Override
