...
public class CommentAdapter extends ListBaseAdapter<ActivityModel> {
    Context context;
    ...
    public void onBindItemHolder(SuperViewHolder holder, int position) {
        ...
        myactivity_time.setText(AppUtil.getStrTime(item.getStartTime())+"-"+AppUtil.getStrTime(item.getEndTime()));
